...
puts "                              .--.                  Try not.
    ...
    def print_student_info(student)
        ...
        puts "Treehouse: #{student.treehouse}"
        puts "Codeschool: #{student.codeschool}"
        puts "Coderwall: #{student.coderwall}"
        puts "Favorite Cities: #{student.cities}"
        puts "Favorite Links: #{student.favorites}"
        puts ""
        puts "-------------------------------------------------"
